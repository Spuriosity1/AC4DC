...
public:
	...
	int pract_infinity() const { return infinity; }
	int occupancy() const { return occup_number; }//might be fractional for future uses
	int turn_pt() const { return turn; }
	
	bool is_shell() const {return shell_flag;}
