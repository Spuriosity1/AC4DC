...
RadialWF::RadialWF(const RadialWF& other) : PairFunction(other), 
    Energy(other.Energy), n(other.n), l(other.l), 
    infinity(other.infinity), turn(other.turn), occup_number(other.occup_number),
    shell_flag(other.shell_flag)
{}
