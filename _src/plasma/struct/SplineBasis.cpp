...
// Be aware: std::function is __slow__.
 ...
 * Responsible for disentangling the codependent 
 * expansion coefficients from one another, 
 * i.e. it deals with non-orthogonality.
 * @details
 */
